...
// CHECK-MESSAGES: :[[@LINE-1]]:12: warning: file-scope object 'single_use_var' is only used in function 'use_single_var'; consider defining it at block scope
...
// Compliant - static variable not used anywhere (different issue - unused)
static int unused_var = 0;
...
// Compliant - static variable used in multiple places within same function
...
// CHECK-MESSAGES: :[[@LINE-7]]:12: warning: file-scope object 'same_func_multi_use' is only used in function 'use_multiple_times'
