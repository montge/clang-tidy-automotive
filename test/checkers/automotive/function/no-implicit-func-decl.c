// RUN: clang-tidy %s --checks='-*,automotive-implicit-function-decl' -- -std=c89 -Wno-implicit-function-declaration -Wno-comment 2>&1 | FileCheck %s

// CHECK-DAG: warning: function 'undeclared_func' is called without a prior declaration
// CHECK-DAG: warning: function 'another_undeclared' is called without a prior declaration
// CHECK-DAG: warning: function 'implicit_void' is called without a prior declaration
// CHECK-DAG: warning: function 'implicit_in_expr' is called without a prior declaration
