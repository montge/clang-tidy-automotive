//===--- AvoidImplicitConversionOperatorCheck.cpp - clang-tidy ------------===//
//
...
void AvoidImplicitConversionOperatorCheck::registerMatchers(
    MatchFinder *Finder) {
...
void AvoidImplicitConversionOperatorCheck::check(
  ...
  diag(Conversion->getLocation(),
       "conversion operator to %0 should be explicit to avoid unintended "
