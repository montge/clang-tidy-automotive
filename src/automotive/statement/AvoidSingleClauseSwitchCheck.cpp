//===--- AvoidSingleClauseSwitchCheck.cpp - clang-tidy --------------------===//
//
...
void AvoidSingleClauseSwitchCheck::registerMatchers(MatchFinder *Finder) {
  Finder->addMatcher(switchStmt().bind("switch"), this);
}

void AvoidSingleClauseSwitchCheck::check(
  ...
  if (ClauseCount < 2) {
    diag(Switch->getSwitchLoc(),
         "switch statement shall have at least two switch-clauses");
  }
}
