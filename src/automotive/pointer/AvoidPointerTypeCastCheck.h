//===--- AvoidPointerTypeCastCheck.h - clang-tidy --------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOMOTIVE_AVOIDPOINTERTYPECASTCHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOMOTIVE_AVOIDPOINTERTYPECASTCHECK_H
...
/// @endcode
class AvoidPointerTypeCastCheck : public ClangTidyCheck {
public:
  AvoidPointerTypeCastCheck(StringRef Name, ClangTidyContext *Context)
      : ClangTidyCheck(Name, Context) {}

  /// Destructor.
  ~AvoidPointerTypeCastCheck() override = default;
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOMOTIVE_AVOIDPOINTERTYPECASTCHECK_H
