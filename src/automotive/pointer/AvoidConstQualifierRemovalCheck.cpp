//===--- AvoidConstQualifierRemovalCheck.cpp - clang-tidy ----------------===//
//
...
void AvoidConstQualifierRemovalCheck::registerMatchers(MatchFinder *Finder) {
  // Match C-style casts and explicit C++ casts
...
void AvoidConstQualifierRemovalCheck::check(
